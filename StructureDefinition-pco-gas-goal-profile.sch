...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Goal">
      <sch:assert test="count(f:extension[@url = 'http://mtnlotus.com/uv/pco/StructureDefinition/pco-goal-attainment-scaling']) &gt;= 5">extension with URL = 'http://mtnlotus.com/uv/pco/StructureDefinition/pco-goal-attainment-scaling': minimum cardinality of 'extension' is 5</sch:assert>
